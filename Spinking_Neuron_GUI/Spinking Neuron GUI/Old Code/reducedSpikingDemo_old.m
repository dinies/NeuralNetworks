...
for t = 1:simulation_length; %there will be simulation_length # of time steps
    ...
    subplot(2,2,3), drawnow, plot(Rec_record(10,1:t), 'linewidth', 2), title('Voltage of receptor #10') %Plot the voltage change of receptor #10
       subplot(2,2,4), drawnow, plot(Rec_record(200,1:t), 'black', 'linewidth', 2), title('Voltage of receptor #200') %Plot the voltage change of receptor #200
end;